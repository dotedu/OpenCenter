...
class RoleModel extends Model
{
    ...
    protected $insertFields='name,title,description,type,sort,status,create_time';
    protected $updateFields='id,name,title,description,type,sort,status,update_time';
    /**
     * 插入数据
     * @param $data
     * @return mixed
