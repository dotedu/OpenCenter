...
class RoleModel extends Model
{
    ...
    protected $insertFields='group_id,name,title,description,type,audit,sort,status,create_time';
    protected $updateFields='id,group_id,name,title,description,type,audit,sort,status,update_time';
    /**
     * 插入数据
     * @param $data
     * @return mixed
